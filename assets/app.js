...
function search() {
    ...
    var queryURL = "https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key=6f875a93bea94a66ada56d27a190dc28&q=" + searchTerm; //+ "&begin_date=" + startYear + "&end_date=" + endYear;
